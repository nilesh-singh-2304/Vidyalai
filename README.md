...
- [ 1] Make the top nav bar sticky during scrolling.
- [ 1] Implement functionality to load more posts upon clicking the "Load More" button. Hide the "Load More" button if no posts exist.
- [ 1] Display the user's name and email in each post. Show the first letter for both the first and last names.
...
- [ 1] Convert `UserList` React class component to functional component and
- [ ] convert `witUserData` HOC (Higher order Component) to a custom React hooks
